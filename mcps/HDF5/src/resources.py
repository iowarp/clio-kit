"""
Resource management for HDF5 MCP server.

This module handles resource management, including:
- File handle caching
...
import h5py
import numpy as np
from mcp.types import Resource, EmbeddedResource
...
class ResourceManager:
    ...
    def __init__(self, data_dir: Path = None, cache_capacity: int = 1000):
        ...
        self.storage_index: Dict[str, Any] = {}
        self.cache_db: Dict[str, Any] = {}
        self.history_db: Dict[str, Any] = {}
        ...
        # Removed loading from constructor
...
def get_resources(resource_manager: ResourceManager) -> List[Resource]:
    """
    ...
    for file_info in files:
        resources.append(Resource(
            ...
            description=f"HDF5 file: {file_info['path']}",
            uri=file_info["uri"]
        ))
    ...
    resources.append(Resource(
        ...
        description="Resources not locally stored",
        uri="hdf5://remote_resources"
    ))
    
    # Storage index
    resources.append(Resource(
        name="storage_index",
        description="Index of registered HDF5 files",
        uri="hdf5://storage_index"
    ))
    ...
    resources.append(Resource(
        ...
        uri="hdf5://history_db/sessions"
    ))
    
    # History DB tool calls
    resources.append(Resource(
        name="tool_calls",
        description="Tool call history",
        uri="hdf5://history_db/tool_calls"
    ))
    
    # History DB requests
    resources.append(Resource(
        name="requests",
        description="Client request history",
        uri="hdf5://history_db/requests"
    ))
