...
class TestLoadDataFile:
    ...
    def test_load_json_with_columns(self, temp_json_file):
        ...
        result = load_data_file(temp_json_file, file_format="json", columns=["id", "value"])
    ...
    def test_load_excel_with_sheet_name(self, temp_excel_file):
        ...
        result = load_data_file(temp_excel_file, file_format="excel", sheet_name="Sheet1")
...
class TestSaveDataFile:
    ...
    def test_save_unsupported_format(self, sample_data_dict):
        ...
        try:
            result = save_data_file(sample_data_dict, temp_file, file_format="unsupported")
