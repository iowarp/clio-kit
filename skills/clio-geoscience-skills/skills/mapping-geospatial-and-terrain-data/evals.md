...
Current acceptance criterion: Report source, CRS and axis order, validation results, spatial predicate/buffer, terrain cell size and units, and output path. Structural GeoJSON validation does not prove topology or scientific correctness.
...
Prompt: "Validate this GeoJSON and render a map of the monitors."
