---
title: ParaView MCP
description: "ParaView MCP v1.0.0 - Part of Agent Toolkit (IoWarp Platform). 29 tools for scientific 3D visualization: load scientific data, generate isosurfaces, create slices, volume rendering, flow streamlines, color mapping, histogram analysis, ADIOS2/BP5 support. Enables AI agents to create autonomous scientific visualizations."
---
