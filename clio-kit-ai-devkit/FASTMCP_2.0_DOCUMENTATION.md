...
**Purpose**: Complete FastMCP 2.0 patterns and CLIO Kit MCP server development reference
**For**: CLIO Kit (IoWarp Platform) - MCP Server Development
...
**Current State**: HDF5 MCP v1.0.0 using standard MCP SDK
...
**Not Recommended Now**: HDF5 v1.0.0 is production-ready and stable
...
**DO NOT MIGRATE NOW** - HDF5 v1.0.0 is production-ready and stable
